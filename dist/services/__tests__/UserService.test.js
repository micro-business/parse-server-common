...
describe('signUpWithUsernameAndPassword', function() {
  test(
    'should return the new signed up user',
    _asyncToGenerator(
...
describe('signInWithUsernameAndPassword', function() {
  test(
    'should fail if email address does not exist',
    _asyncToGenerator(
  ...
  test(
    'should fail if password is wrong',
    _asyncToGenerator(
...
describe('getUserInfo', function() {
  test(
    'should reject if username does not exist',
    _asyncToGenerator(
